    ...
    return (
        <div className='w-full h-fit lg:h-auto flex flex-col lg:flex-row items-center justify-between gap-[3rem] lg:gap-[11rem] mt-[max(4rem,28vw)] min-[450px]:mt-[max(6rem,21vw)] md:mt-[13rem] lg:mt-[4rem] px-[2rem] lg:px-[4rem] pb-[5rem]'>
            <div className='flex max-w-[400px] min-[450px]:max-w-fit lg:max-w-[400px] w-auto  h-fit relative group'>
                <a href="https://somy-todolist.netlify.app/" target='_blank' className='flex  justify-center w-auto h-auto lg:h-[27rem] lg:max-h-[450px]  items-end z-[2] relative hover:scale-[1.15]  duration-[270ms] ease-in-out '>
                    <img src={TODO} alt="Smooth Scrolling" className='aspect-[.7/1] w-fit  object-cover absolute z-[1] h-full lg:h-[92.7%]  ' />
            ...
            <span className='hidden absolute left-[21.35%] min-[1350px]:left-[21.6%]  lg:flex items-center h-auto'>
                ...
                <a href="https://somy-todolist.netlify.app/" target='_blank' className='w-[1rem] h-[1rem] bg-[#0B111E] relative z-[2] rounded-4xl border-[3px] border-solid border-[#f73842ec] hover:scale-[1.2] transition-transform duration-[170ms] ease-in-out'></a>
            </span>
        </div>
    )
}
