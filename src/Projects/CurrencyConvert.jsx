...
const CurrencyConvert = () => {
    const skills = ["Html", "CSS", "TailwindCSS", "React", "useState", "useRef", "useEffect", "Fetch api"]
    return (
        <div className='w-full h-fit lg:h-auto flex flex-col lg:flex-row-reverse items-center justify-between gap-[3rem] lg:gap-[11rem] mt-[max(4rem,28vw)] min-[450px]:mt-[max(6rem,21vw)] md:mt-[12rem] lg:mt-[3rem] px-[2rem] lg:px-[4rem] pb-[5rem]'>
            <div className='flex max-w-[400px] min-[450px]:max-w-fit lg:max-w-[400px] w-auto  h-fit relative group'>
                <a href="https://somycurrencyconvertor.netlify.app/" target='_blank' className='flex  justify-center w-auto h-auto lg:h-[27rem] lg:max-h-[450px] items-end z-[2] relative hover:scale-[1.15]  duration-[270ms] ease-in-out '>
                    <img src="/src/assets/Currency.webp" alt="Smooth Scrolling" className='aspect-[.7/1]  w-fit  object-cover absolute  z-[1] h-full lg:h-[92.7%] ' />
                    ...
                    <span className='lg:group-hover:top-[-2rem] absolute top-[-16vw] min-[450px]:top-[-27%] lg:top-[20%] md:top-[-19%] text-[#0B111E] text-[max(.7rem,3.5vw)] min-[450px]:text-[max(1rem,3vw)] md:text-[max(1.45rem,2.7vw)] lg:text-[clamp(0.875rem,0.4816rem+0.6148vw,1.25rem)] font-semibold flex items-center justify-around  shadow-[0_5px_10px_rgba(0,0,0,0.3)] transition-[top_0.3s_cubic-bezier(0.68,-0.55,0.265,1.55)]  w-auto px-[1rem] py-[0.4rem] rounded-lg bg-[#FFFF] after:absolute after:w-[0.7rem] after:h-[0.7rem] after:bg-[#FFFF] after:rotate-45 after:bottom-[-0.3rem] after:right-[45%]  '>Currency Convertor
                        <GoLinkExternal className='w-auto h-auto ml-[.3rem] ' />
                    </span>
                </a>
            </div>
            <span className='w-full md:pl-[1rem] lg:p-0 lg:max-w-[45%] flex flex-col items-start gap-[1rem] text-[#FFFFFF]'>
                <span>
                    <h1 className='text-[max(1.6rem,7.2vw)] min-[450px]:text-[max(2rem,6.5vw)] md:text-[max(3rem,5.5vw)] lg:text-[clamp(1.875rem,1.2193rem+1.0246vw,2.5rem)] font-bold'>Currency Convertor</h1>
                ...
                <p className='text-[#E8EEF1] text-[max(.7rem,3.5vw)] min-[450px]:text-[max(1rem,3vw)] md:text-[max(1.5rem,3vw)] lg:text-[clamp(0.875rem,0.4816rem+0.6148vw,1.25rem)]'>I made this app when I started learning React. This app use an external API to fetch live currency rates. It is a reliable tool designed to convert currencies in real-time using up-to-date exchange rates.</p>
            ...
            <span className='hidden absolute right-[21.3%] min-[1350px]:right-[21.5%] lg:flex lg:flex-row-reverse items-center h-auto'>
                <div className='relative bg-[#FFFFFF] w-[28vw] h-[0.07rem]'>
                </div>
                <a href="https://somycurrencyconvertor.netlify.app/" target='_blank' className='w-[1rem] h-[1rem] bg-[#0B111E] relative z-[2] rounded-4xl border-[3px] border-solid border-[#FFFFFF] hover:scale-[1.2] transition-transform duration-[170ms] ease-in-out'></a>
            </span>
        </div>
    )
}
