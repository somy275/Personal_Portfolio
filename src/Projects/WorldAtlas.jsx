    ...
    return (
        <div className='w-full h-fit lg:h-auto flex flex-col lg:flex-row items-center justify-between gap-[3rem] lg:gap-[11rem] mt-[max(7rem,37vw)] min-[450px]:mt-[max(10rem,28vw)] md:mt-[13rem] lg:mt-[4rem] px-[2rem] lg:px-[4rem] pb-[6rem]'>
            <div className='flex w-auto min-[450px]:w-[100%] max-w-[400px] min-[450px]:max-w-[600px] lg:w-auto lg:max-w-[max(400px,30vw)] h-fit relative group'>
                <a href="https://www.worldatlas.com/" target='_blank' className='flex  justify-center w-auto h-auto lg:h-[max(16rem,19vw)]  items-end z-[2] relative hover:scale-[1.15]  duration-[270ms] ease-in-out '>
                    <img src="/src/assets/WorldAtlas.webp" alt="WorldAtlas" className=' aspect-[1/.645] w-auto object-cover absolute top-[1.5vw] lg:top-[14%] right-[9vw] md:right-[4rem] lg:right-[10.5%] z-[1] h-[90%] lg:h-[80%]' />
